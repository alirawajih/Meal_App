...
class FiltersScreen extends ConsumerWidget {
  ...
  // void _setidentifier(String identifier) {
      ...
      body: Column(
        children: [
          SwitchListTile(
            ...
            subtitle: Text(
              'Only incloude galuten-free meals ',
              style: Theme.of(context)
                  .textTheme
                  .labelMedium!
                  .copyWith(color: Theme.of(context).colorScheme.onBackground),
          ...
          SwitchListTile(
            ...
            subtitle: Text(
              'Only incloude Vegetarian meals ',
              style: Theme.of(context)
                  .textTheme
                  .labelMedium!
                  .copyWith(color: Theme.of(context).colorScheme.onBackground),
          ...
          SwitchListTile(
            ...
            subtitle: Text(
              'Only incloude LactoseFree meals ',
              style: Theme.of(context)
                  .textTheme
                  .labelMedium!
                  .copyWith(color: Theme.of(context).colorScheme.onBackground),
